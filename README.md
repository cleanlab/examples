...
| 15  | [transformer_sklearn](transformer_sklearn/transformer_sklearn.ipynb)                                             | Demonstrate how to use `KerasWrapperModel` to make a Keras model sklearn-compatible.      |
