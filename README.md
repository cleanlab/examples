...
| 13  | [multilabel_classification](multilabel_classification/pytorch_network_training.ipynb)                                               | Train a [Pytorch model](https://github.com/cleanlab/examples/blob/master/multilabel_classification/pytorch_network_training.ipynb) on noisily labeled [CelebA](https://mmlab.ie.cuhk.edu.hk/projects/CelebA.html) image data and find errors using cleanlab: [Image tagging](https://github.com/cleanlab/examples/blob/master/multilabel_classification/image_tagging.ipynb).  
