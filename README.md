...
| 12  | [active_learning_single_annotator](active_learning_single_annotator/active_learning_single_annotator.ipynb)                                             | Improve model performance by iteratively collecting additional labeled examples. This active learning pipeline allows for examples labeled in batches with one label per example.                                                             |
